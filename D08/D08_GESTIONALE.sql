...
create table d08_tipo_prodotto (
    ...
    tipo_prodotto                  varchar2(50 char)
                                   constraint d08_tipo_prodot_tipo_prodo_unq unique not null,
...
create table d08_prodotto (
    ...
    tipo_prodotto_id               number
                                   constraint d08_prodotto_tipo_prodotto_fk
...
create table d08_cliente (
    ...
    cliente                        varchar2(50 char)
                                   constraint d08_cliente_cliente_unq unique not null,
...
create table d08_fornitore (
    ...
    fornitore                      varchar2(50 char)
                                   constraint d08_fornitore_fornitore_unq unique not null,
...
create index d08_acquisto_i132 on d08_acquisto (prodotto_id);
...
create index d08_vendita_i182 on d08_vendita (prodotto_id);
...
# settings = { prefix: "d08", onDelete: "RESTRICT", semantics: "CHAR", drop: true, language: "EN", APEX: true }
*/